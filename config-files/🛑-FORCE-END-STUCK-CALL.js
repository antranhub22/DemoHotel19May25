...
function forceEndViaButton() {
  ...
  const voiceButton = document.querySelector(
    '.voice-button, [class*="voice"], [class*="call"]'
  );
  if (voiceButton) {
...
function forceResetUI() {
  ...
  const listeningElements = document.querySelectorAll(
    '[class*="listening"], [class*="active"], .call-active'
  );
