...
import { c } from './services-CkHkMpnV.js';
import { B as d, a as h } from './components-CjbIaAhs.js';
const N = [
    {
      href: '/dashboard',
      icon: u,
  ...
  k = ({
    ...
    const l = e.jsxs(d, {
      ...
      className: c(
        ...
        n && 'bg-primary text-primary-foreground hover:bg-primary/90',
        s && 'opacity-50 cursor-not-allowed hover:bg-transparent'
      ),
      disabled: s,
      children: [
        e.jsx(i, { className: 'h-5 w-5 shrink-0' }),
        e.jsxs('div', {
          className: 'flex-1 text-left',
          children: [
            e.jsx('div', { className: 'font-medium', children: t }),
            e.jsx('div', {
              className: c(
                'text-xs text-muted-foreground',
                n && 'text-primary-foreground/80'
              ),
              children: a,
            }),
          ],
          ...
          : r === 'basic'
            ...
            : r === 'premium'
              ...
              : r === 'enterprise'
                ? 'Doanh nghiệp'
                : r;
    return e.jsx(h, { variant: t(), className: 'text-xs', children: a() });
  },
  C = (r, i) => {
    if (!i) return !0;
    const t = { trial: 0, basic: 1, premium: 2, enterprise: 3 },
      a = t[r] ?? 0,
      n = t[i] ?? 0;
    return a >= n;
  },
  A = ({ isOpen: r, onClose: i, tenantData: t }) => {
    const [a] = j(),
      n = [
        ...N,
        ...y.filter(s => s.requiresPlan && t.subscriptionPlan !== 'trial'),
      ];
    return e.jsx('aside', {
      className: c(
        ...
        children: [
          ...
          e.jsxs('div', {
            ...
            children: [
              ...
              e.jsx(o, {
                href: '/interface1',
                className:
                  'block mt-3 px-3 py-2 bg-blue-600 text-white text-sm rounded hover:bg-blue-700 transition text-center',
                children: 'Xem giao diện khách',
              }),
            ],
          }),
          e.jsx('nav', {
            ...
            children: n.map(s => {
              const l = C(t.subscriptionPlan, s.requiresPlan);
              return e.jsx(
                k,
                {
                  href: s.href,
          ...
          e.jsx('div', {
            ...
            children: e.jsx('p', {
              ...
              children: '© 2024 Talk2Go. All rights reserved.',
            }),
          }),
        ],
      }),
