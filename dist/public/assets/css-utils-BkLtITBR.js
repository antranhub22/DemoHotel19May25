...
const B = '-',
  ...
  le = e => {
    ...
    return (
      ae(Object.entries(e.classGroups), t).forEach(([n, a]) => {
        $(a, o, n, r);
      }),
      o
    );
  ...
  ue = e => ({ cache: ce(e.cacheSize), parseClassName: de(e), ...ne(e) }),
  be = /\s+/,
  ge = (e, r) => {
    const {
        parseClassName: t,
...
const c = e => {
  ...
  C = e => M(e) || ye.has(e) || he.test(e),
  z = e => G(e, 'length', Ie),
  M = e => !!e && !Number.isNaN(Number(e)),
  _ = e => G(e, 'number', M),
  I = e => !!e && Number.isInteger(Number(e)),
  ze = e => e.endsWith('%') && M(e.slice(0, -1)),
  i = e => te.test(e),
  A = e => xe.test(e),
  Ae = new Set(['length', 'size', 'percentage']),
  Se = e => G(e, Ae, oe),
  Me = e => G(e, 'position', oe),
  ...
  Ee = () => {
    ...
    return {
      ...
      classGroups: {
        ...
        grow: [{ grow: P() }],
        shrink: [{ shrink: P() }],
        order: [{ order: ['first', 'last', 'none', I, i] }],
        'grid-cols': [{ 'grid-cols': [j] }],
        'col-start-end': [{ col: ['auto', { span: ['full', I, i] }, i] }],
        'col-start': [{ 'col-start': E() }],
        'col-end': [{ 'col-end': E() }],
        'grid-rows': [{ 'grid-rows': [j] }],
        'row-start-end': [{ row: ['auto', { span: [I, i] }, i] }],
        ...
        'bg-size': [{ bg: ['auto', 'cover', 'contain', Se] }],
        'bg-image': [
          {
            bg: [
              'none',
