...
// ✅ TEMP FIX: Change to function declaration to avoid redeclaration error
function findInDictionary(fragments: string[]): DictionaryEntry | null {
