...
export interface AssistantCustomization {
  personality: 'professional' | 'friendly' | 'luxurious' | 'casual' | 'enthusiastic';
...
export class DashboardApi {
   ...
   */
  async updateAssistantConfig(request: UpdateAssistantConfigRequest): Promise<{ success: boolean }> {
    try {
      const response = await apiRequest({
...
export const validateAssistantCustomization = (data: any): data is AssistantCustomization => {
  return data &&
         ['professional', 'friendly', 'luxurious', 'casual', 'enthusiastic'].includes(data.personality) &&
...
export const PERSONALITY_OPTIONS = [
  { value: 'professional', label: 'Chuyên nghiệp', description: 'Lịch sự, trang trọng và đáng tin cậy' },
  { value: 'friendly', label: 'Thân thiện', description: 'Ấm áp, dễ gần và hữu ích' },
  { value: 'luxurious', label: 'Sang trọng', description: 'Tinh tế, đẳng cấp và chuyên nghiệp' },
  { value: 'casual', label: 'Thoải mái', description: 'Tự nhiên, gần gũi và dễ chịu' },
  { value: 'enthusiastic', label: 'Nhiệt tình', description: 'Tích cực, năng động và sôi nổi' }
] as const;

export const TONE_OPTIONS = [
  { value: 'formal', label: 'Trang trọng', description: 'Lịch sự và chuyên nghiệp' },
  { value: 'friendly', label: 'Thân thiện', description: 'Ấm áp và dễ gần' },
  { value: 'warm', label: 'Ấm áp', description: 'Gần gũi và chăm sóc' },
  { value: 'energetic', label: 'Năng động', description: 'Tích cực và sôi nổi' },
...
export const BACKGROUND_SOUND_OPTIONS = [
  { value: 'hotel-lobby', label: 'Sảnh khách sạn', description: 'Nhạc nền nhẹ nhàng' },
