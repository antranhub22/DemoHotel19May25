...
const VOICE_PROMPTS: Record<string, Record<Language, VoicePrompt['prompts']>> = {
  'Room Service': {
    en: {
      greeting: "Hello! I'm your room service assistant. What would you like to order?",
      instructions: "You can order food, drinks, or request dining setup in your room.",
      examples: [
        "I'd like to order breakfast for two",
        "Can I get a bottle of wine delivered?",
        "Please bring clean towels and toiletries"
      ],
      fallback: "I can help you with room service orders. Please tell me what you need."
    },
    vi: {
      greeting: "Xin chào! Tôi là trợ lý dịch vụ phòng. Quý khách muốn gọi món gì?",
      instructions: "Quý khách có thể gọi món ăn, đồ uống, hoặc yêu cầu setup bàn ăn trong phòng.",
      examples: [
        "Tôi muốn gọi bữa sáng cho hai người",
        "Cho tôi một chai rượu vang được không?",
        "Làm ơn mang khăn sạch và đồ dùng vệ sinh"
      ],
      fallback: "Tôi có thể giúp quý khách đặt dịch vụ phòng. Xin hãy cho biết quý khách cần gì."
    },
    fr: {
      greeting: "Bonjour! Je suis votre assistant de service en chambre. Que souhaitez-vous commander?",
      instructions: "Vous pouvez commander de la nourriture, des boissons, ou demander un service de table.",
      examples: [
      ...
      fallback: "Je peux vous aider avec les commandes de service en chambre. Dites-moi ce dont vous avez besoin."
    },
    zh: {
    ...
    ru: {
      greeting: "Здравствуйте! Я ваш помощник по обслуживанию номеров. Что бы вы хотели заказать?",
      instructions: "Вы можете заказать еду, напитки или попросить сервировку в номере.",
      examples: [
      ...
      fallback: "Я могу помочь с заказом обслуживания номеров. Скажите, что вам нужно."
    },
    ko: {
      greeting: "안녕하세요! 룸서비스 도우미입니다. 무엇을 주문하시겠습니까?",
      instructions: "음식, 음료를 주문하시거나 객실 내 식사 준비를 요청하실 수 있습니다.",
      examples: [
        "두 명을 위한 아침식사를 주문하고 싶습니다",
        "와인 한 병을 배달받을 수 있나요?",
        "깨끗한 수건과 세면도구를 가져다 주세요"
      ],
      fallback: "룸서비스 주문을 도와드릴 수 있습니다. 필요한 것을 말씀해 주세요."
    }
  },
  'Restaurant': {
    en: {
      greeting: "Welcome to our restaurant service! How can I help you with dining?",
      instructions: "I can help with reservations, menu information, and special dietary requirements.",
      examples: [
        "I'd like to make a dinner reservation for tonight",
        "What's on today's special menu?",
        "Do you have vegetarian options?"
      ],
      fallback: "I can assist with restaurant reservations and dining information."
    },
    vi: {
      greeting: "Chào mừng đến với dịch vụ nhà hàng! Tôi có thể giúp gì về việc ăn uống?",
      instructions: "Tôi có thể hỗ trợ đặt bàn, thông tin thực đơn và yêu cầu ăn kiêng đặc biệt.",
      examples: [
    ...
    fr: {
      greeting: "Bienvenue au service restaurant! Comment puis-je vous aider avec la restauration?",
      instructions: "Je peux vous aider avec les réservations, informations menu et exigences diététiques.",
      examples: [
        "J'aimerais faire une réservation pour ce soir",
        "Qu'y a-t-il au menu spécial aujourd'hui?",
        "Avez-vous des options végétariennes?"
      ],
      fallback: "Je peux vous aider avec les réservations de restaurant et les informations culinaires."
    },
    zh: {
    ...
    ru: {
      greeting: "Добро пожаловать в ресторанный сервис! Как я могу помочь с питанием?",
      instructions: "Могу помочь с бронированием, информацией о меню и особыми диетическими требованиями.",
      examples: [
        "Я хотел бы забронировать ужин на сегодня",
        "Что есть в сегодняшнем специальном меню?",
        "У вас есть вегетарианские блюда?"
      ],
      fallback: "Могу помочь с бронированием ресторана и информацией о питании."
    },
    ko: {
      greeting: "레스토랑 서비스에 오신 것을 환영합니다! 식사와 관련해 어떻게 도와드릴까요?",
      instructions: "예약, 메뉴 정보, 특별 식단 요구사항을 도와드릴 수 있습니다.",
      examples: [
        "오늘 저녁 예약을 하고 싶습니다",
        "오늘의 특별 메뉴는 무엇인가요?",
        "채식 옵션이 있나요?"
  ...
  'Concierge': {
    en: {
      greeting: "Hello! I'm your concierge assistant. How can I help enhance your stay?",
      instructions: "I can assist with local recommendations, bookings, transportation, and general inquiries.",
      examples: [
        "Can you recommend good restaurants nearby?",
        "I need a taxi to the airport",
        "What tourist attractions are worth visiting?"
      ],
      fallback: "I'm here to help with any requests to make your stay more comfortable."
    },
    vi: {
      greeting: "Xin chào! Tôi là trợ lý lễ tân. Tôi có thể giúp gì để chuyến lưu trú của quý khách tốt hơn?",
      instructions: "Tôi có thể hỗ trợ gợi ý địa phương, đặt chỗ, di chuyển và các câu hỏi chung.",
      examples: [
        "Bạn có thể gợi ý nhà hàng ngon gần đây không?",
        "Tôi cần taxi đến sân bay",
        "Có điểm du lịch nào đáng thăm?"
      ],
      fallback: "Tôi ở đây để giúp mọi yêu cầu làm cho chuyến lưu trú của quý khách thoải mái hơn."
    },
    fr: {
      greeting: "Bonjour! Je suis votre assistant concierge. Comment puis-je améliorer votre séjour?",
      instructions: "Je peux vous aider avec des recommandations locales, réservations et transport.",
      examples: [
      ...
      fallback: "Je suis là pour vous aider avec toute demande pour rendre votre séjour plus confortable."
    },
    zh: {
    ...
    ru: {
      greeting: "Здравствуйте! Я ваш помощник-консьерж. Как я могу улучшить ваше пребывание?",
      instructions: "Могу помочь с местными рекомендациями, бронированием, транспортом и общими вопросами.",
      examples: [
      ...
      fallback: "Я здесь, чтобы помочь с любыми запросами для комфортного пребывания."
    },
    ko: {
      greeting: "안녕하세요! 컨시어지 도우미입니다. 어떻게 숙박을 더 즐겁게 도와드릴까요?",
      instructions: "지역 추천, 예약, 교통편, 일반 문의를 도와드릴 수 있습니다.",
      examples: [
        "근처 좋은 레스토랑을 추천해 주실 수 있나요?",
        "공항까지 택시가 필요합니다",
        "방문할 만한 관광 명소가 있나요?"
      ],
      fallback: "숙박을 더 편안하게 만들어 드리기 위한 모든 요청을 도와드립니다."
    }
  },
  // Add more services like Housekeeping, Maintenance, etc.
  'Housekeeping': {
    en: {
      greeting: "Hello! I'm here to help with housekeeping services. What can I assist you with?",
      instructions: "I can help with room cleaning, towel replacement, amenity requests, and maintenance issues.",
      examples: [
    ...
    vi: {
      greeting: "Xin chào! Tôi ở đây để giúp dịch vụ dọn phòng. Tôi có thể hỗ trợ gì?",
      instructions: "Tôi có thể hỗ trợ dọn phòng, thay khăn, yêu cầu tiện nghi và vấn đề bảo trì.",
      examples: [
    ...
    // Add other languages...
    fr: { greeting: "Bonjour! Je suis là pour les services de ménage.", instructions: "", examples: [], fallback: "" },
    zh: { greeting: "您好！我来帮助客房清洁服务。", instructions: "", examples: [], fallback: "" },
    ru: { greeting: "Здравствуйте! Я здесь для услуг уборки.", instructions: "", examples: [], fallback: "" },
    ko: { greeting: "안녕하세요! 하우스키핑 서비스를 도와드립니다.", instructions: "", examples: [], fallback: "" }
  }
};
...
export const VoiceCommandContext: React.FC<VoiceCommandContextProps> = ({
  ...
  const generateVoicePrompt = useCallback((service: ServiceCategory, lang: Language): VoicePrompt | null => {
    ...
    if (!servicePrompts || !servicePrompts[lang]) {
      logger.warn(`No voice prompts found for service: ${service.name}, language: ${lang}`, 'Component');
      return null;
    }
  ...
  useEffect(() => {
    ...
    logger.debug(`🎤 [VoiceCommandContext] Generating prompt for service: ${selectedService.name}, language: ${language}`, 'Component');
    ...
    if (prompt) {
      ...
      logger.debug(`✅ [VoiceCommandContext] Voice prompt ready for: ${selectedService.name}`, 'Component');
    } else {
      setCurrentPrompt(null);
      setIsReady(false);
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && currentPrompt && isCallActive) {
      ...
      logger.debug(`🌐 [VoiceCommandContext] Voice context injected for active call`, 'Component');
      ...
      {import.meta.env.DEV && currentPrompt && (
        ...
        `}>
          ...
          <div className="space-y-1 text-xs">
            ...
            <div>Language: <span className="text-white">{currentPrompt.language}</span></div>
