...
> = {
  "Room Service": {
    ...
    ko: {
      greeting: "안녕하세요! 룸서비스 도우미입니다. 무엇을 주문하시겠어요?",
      instructions:
        "음식과 음료를 주문하시거나 객실 내 식사 세팅을 요청하실 수 있어요.",
      examples: [
        "두 사람을 위한 아침 식사를 주문하고 싶어요",
        "와인 한 병 배달 가능할까요?",
        "깨끗한 수건과 세면도구 부탁드려요",
      ],
      fallback:
        "룸서비스 주문을 도와드릴 수 있어요. 필요한 내용을 말씀해 주세요.",
    },
  },
  Restaurant: {
    en: {
    ...
    ko: {
      greeting:
        "레스토랑 서비스에 오신 것을 환영합니다! 식사 관련 도와드릴까요?",
      instructions: "예약, 메뉴 안내, 식이요법 관련 요청을 도와드릴 수 있어요.",
      examples: [
        "오늘 저녁 예약하고 싶어요",
        "오늘의 스페셜 메뉴는 무엇인가요?",
        "채식 메뉴가 있나요?",
      ],
      fallback: "레스토랑 예약과 식사 정보를 도와드릴 수 있어요.",
    },
  },
  Concierge: {
    en: {
    ...
    ko: {
      greeting:
        "안녕하세요! 컨시어지 도우미입니다. 더 나은 숙박을 위해 무엇을 도와드릴까요?",
      instructions: "현지 추천, 예약, 교통, 일반 문의를 도와드릴 수 있어요.",
      examples: [
        "근처 맛집을 추천해 주시겠어요?",
        "공항까지 택시가 필요해요",
        "가볼 만한 관광지가 있나요?",
      ],
      fallback: "더 편안한 숙박을 위해 필요한 모든 요청을 도와드릴게요.",
    },
  },
  ...
  Housekeeping: {
    ...
    ko: {
      greeting: "안녕하세요! 하우스키핑 서비스를 도와드릴게요.",
      instructions:
        "객실 청소, 수건 교체, 비품 요청, 간단한 유지보수를 도와드릴 수 있어요.",
      examples: [
        "객실 청소 부탁드려요",
        "깨끗한 수건이 필요해요",
        "베개를 더 가져다 주실 수 있나요?",
      ],
      fallback: "하우스키핑 및 객실 유지보수 요청을 도와드릴게요.",
    },
  },
};
