...
exports.staff = exports.message = exports.request = exports.transcript = exports.call = exports.hotelProfiles = exports.tenants = exports.sqliteStaff = exports.sqliteMessage = exports.sqliteRequest = exports.sqliteTranscript = exports.sqliteCall = exports.pgStaff = exports.pgMessage = exports.pgRequest = exports.pgTranscript = exports.pgCall = exports.sqliteHotelProfiles = exports.sqliteTenants = exports.pgHotelProfiles = exports.pgTenants = void 0;
// Import both PostgreSQL and SQLite types
var sqlite_core_1 = require("drizzle-orm/sqlite-core");
var pg_core_1 = require("drizzle-orm/pg-core");
// Determine database type from environment
var isPostgres = process.env.NODE_ENV === 'production' || ((_a = process.env.DATABASE_URL) === null || _a === void 0 ? void 0 : _a.includes('postgres'));
// ============================================
...
exports.pgTenants = (0, pg_core_1.pgTable)('tenants', {
    ...
    subdomain: (0, pg_core_1.varchar)('subdomain', { length: 50 }).unique().notNull(),
    customDomain: (0, pg_core_1.varchar)('custom_domain', { length: 100 }),
    subscriptionPlan: (0, pg_core_1.varchar)('subscription_plan', { length: 20 }).default('trial'),
...
exports.pgHotelProfiles = (0, pg_core_1.pgTable)('hotel_profiles', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    tenantId: (0, pg_core_1.uuid)('tenant_id').references(function () { return exports.pgTenants.id; }).notNull(),
...
exports.sqliteTenants = (0, sqlite_core_1.sqliteTable)('tenants', {
    ...
    subscriptionPlan: (0, sqlite_core_1.text)('subscription_plan').default('trial'),
    subscriptionStatus: (0, sqlite_core_1.text)('subscription_status').default('active'),
    trialEndsAt: (0, sqlite_core_1.integer)('trial_ends_at', { mode: 'timestamp' }),
    ...
    voiceCloning: (0, sqlite_core_1.integer)('voice_cloning', { mode: 'boolean' }).default(false),
    multiLocation: (0, sqlite_core_1.integer)('multi_location', { mode: 'boolean' }).default(false),
    whiteLabel: (0, sqlite_core_1.integer)('white_label', { mode: 'boolean' }).default(false),
    dataRetentionDays: (0, sqlite_core_1.integer)('data_retention_days').default(90),
    monthlyCallLimit: (0, sqlite_core_1.integer)('monthly_call_limit').default(1000)
});
// SQLite Hotel Profiles Table
exports.sqliteHotelProfiles = (0, sqlite_core_1.sqliteTable)('hotel_profiles', {
    id: (0, sqlite_core_1.text)('id').primaryKey().$defaultFn(function () { return crypto.randomUUID(); }),
    tenantId: (0, sqlite_core_1.text)('tenant_id').references(function () { return exports.sqliteTenants.id; }).notNull(),
    researchData: (0, sqlite_core_1.text)('research_data', { mode: 'json' }),
    assistantConfig: (0, sqlite_core_1.text)('assistant_config', { mode: 'json' }),
...
exports.pgCall = (0, pg_core_1.pgTable)('call', {
    ...
    callIdVapi: (0, pg_core_1.varchar)('call_id_vapi', { length: 100 }).notNull().unique(),
    ...
    tenantId: (0, pg_core_1.uuid)('tenant_id').references(function () { return exports.pgTenants.id; })
});
...
exports.pgRequest = (0, pg_core_1.pgTable)('request', {
    ...
    status: (0, pg_core_1.varchar)('status', { length: 100 }).default('Đã ghi nhận'),
    createdAt: (0, pg_core_1.timestamp)('created_at').defaultNow(),
    updatedAt: (0, pg_core_1.timestamp)('updated_at').defaultNow(),
    // NEW: Tenant isolation
    tenantId: (0, pg_core_1.uuid)('tenant_id').references(function () { return exports.pgTenants.id; })
...
exports.pgMessage = (0, pg_core_1.pgTable)('message', {
    id: (0, pg_core_1.integer)('id').primaryKey().generatedAlwaysAsIdentity(),
    requestId: (0, pg_core_1.integer)('request_id').references(function () { return exports.pgRequest.id; }),
...
exports.sqliteCall = (0, sqlite_core_1.sqliteTable)('call', {
    ...
    startTime: (0, sqlite_core_1.integer)('start_time', { mode: 'timestamp' }).$defaultFn(function () { return new Date(); }),
    endTime: (0, sqlite_core_1.integer)('end_time', { mode: 'timestamp' }),
    duration: (0, sqlite_core_1.integer)('duration'),
    createdAt: (0, sqlite_core_1.integer)('created_at', { mode: 'timestamp' }).$defaultFn(function () { return new Date(); }),
    updatedAt: (0, sqlite_core_1.integer)('updated_at', { mode: 'timestamp' }).$defaultFn(function () { return new Date(); }),
    // NEW: Tenant isolation
    tenantId: (0, sqlite_core_1.text)('tenant_id').references(function () { return exports.sqliteTenants.id; })
});
exports.sqliteTranscript = (0, sqlite_core_1.sqliteTable)('transcript', {
    ...
    timestamp: (0, sqlite_core_1.integer)('timestamp', { mode: 'timestamp' }).$defaultFn(function () { return new Date(); }),
    // NEW: Tenant isolation
    tenantId: (0, sqlite_core_1.text)('tenant_id').references(function () { return exports.sqliteTenants.id; })
});
...
exports.sqliteMessage = (0, sqlite_core_1.sqliteTable)('message', {
    id: (0, sqlite_core_1.integer)('id').primaryKey({ autoIncrement: true }),
    requestId: (0, sqlite_core_1.integer)('request_id').references(function () { return exports.sqliteRequest.id; }),
...
exports.hotelProfiles = isPostgres ? exports.pgHotelProfiles : exports.sqliteHotelProfiles;
// EXISTING: Updated tables with tenant_id
exports.call = isPostgres ? exports.pgCall : exports.sqliteCall;
exports.transcript = isPostgres ? exports.pgTranscript : exports.sqliteTranscript;
