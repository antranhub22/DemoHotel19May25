...
import { MobileVoiceControls } from '../../../apps/client/src/components/interface1/MobileVoiceControls';
...
jest.mock('../../../apps/client/src/components/interface1/VoiceLanguageSwitcher', () => ({
...
describe('MobileVoiceControls', () => {
  ...
  describe('Expand/Collapse Functionality', () => {
    it('expands when expand button is clicked', async () => {
      ...
      const expandButton = screen.getByRole('button', { name: /expand controls/i });
    ...
    it('collapses when collapse button is clicked', async () => {
      ...
      // Then collapse
      const collapseButton = screen.getByRole('button', { name: /collapse controls/i });
  ...
  describe('Voice Settings', () => {
    ...
    it('toggles auto collapse setting', async () => {
      ...
      const autoCollapseSection = screen.getByText('Auto Collapse').closest('div');
  ...
  describe('Voice Context Display', () => {
    it('shows voice context when service is selected', async () => {
      ...
      expect(screen.getByText(/Voice assistant optimized for.*housekeeping/i)).toBeInTheDocument();
    });
    ...
    it('shows context active indicator during call', async () => {
      ...
      expect(screen.getByText('Context active during call')).toBeInTheDocument();
    });
