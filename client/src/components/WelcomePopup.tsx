      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-blue-900 dark:text-amber-400 font-poppins">Nội dung</h2>
            
            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 text-gray-800 dark:text-white">
                <span role="img" aria-label="target">🎯</span> MỤC ĐÍCH:
              </h3>
              <p className="pl-6 text-gray-700 dark:text-gray-300">
                Thay thế cho nhân sự lễ tân bằng AI Voice Assistant được đào tạo riêng với thông tin và dịch vụ của một khách sạn cụ thể.
              </p>
            </div>

            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 text-gray-800 dark:text-white">
                <span role="img" aria-label="money">💰</span> GIÁ TRỊ MANG LẠI:
              </h3>
            ...
            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 text-gray-800 dark:text-white">
                <span role="img" aria-label="speech bubble">🗣️</span> ĐẶC ĐIỂM NỔI BẬT:
              </h3>
              <p className="pl-6 text-gray-700 dark:text-gray-300">
            ...
            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 text-gray-800 dark:text-white">
                <span role="img" aria-label="bell">🔔</span> CHỨC NĂNG CỦA AI VOICE BOT:
              </h3>
              <ul className="list-inside list-disc pl-6 space-y-1 text-gray-700 dark:text-gray-300">
               ...
               <p className="pl-6 text-xs italic text-gray-600 dark:text-gray-400 mt-1">*Tất cả dịch vụ này sẽ do khách sạn cung cấp</p>
            </div>
             <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 text-gray-800 dark:text-white">
                <span role="img" aria-label="microphone">🎤</span> CÁCH SỬ DỤNG:
              </h3>
              <p className="pl-6 text-gray-700 dark:text-gray-300">
            ...
            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 text-gray-800 dark:text-white">
                <span role="img" aria-label="light bulb">💡</span> THỬ NGAY (6 ngôn ngữ để trải nghiệm):
              </h3>
          ...
          {/* English Content */}
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-blue-900 dark:text-amber-400 font-poppins">Content</h2>
             <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 text-gray-800 dark:text-white">
                <span role="img" aria-label="target">🎯</span> PURPOSE:
              </h3>
              <p className="pl-6 text-gray-700 dark:text-gray-300">
                Replace human receptionists with an AI Voice Assistant trained with the specific information and services of a hotel.
              </p>
            </div>

            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 text-gray-800 dark:text-white">
                <span role="img" aria-label="money">💰</span> VALUE PROPOSITION:
              </h3>
              <ul className="list-inside list-disc pl-6 space-y-1 text-gray-700 dark:text-gray-300">
            ...
            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 text-gray-800 dark:text-white">
                <span role="img" aria-label="speech bubble">🗣️</span> HIGHLIGHT:
              </h3>
              <p className="pl-6 text-gray-700 dark:text-gray-300">
            ...
            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 text-gray-800 dark:text-white">
                <span role="img" aria-label="bell">🔔</span> AI VOICE BOT FEATURES:
              </h3>
              <ul className="list-inside list-disc pl-6 space-y-1 text-gray-700 dark:text-gray-300">
               ...
               <p className="pl-6 text-xs italic text-gray-600 dark:text-gray-400 mt-1">*All these services are provided by the hotel</p>
            </div>

            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 text-gray-800 dark:text-white">
                <span role="img" aria-label="microphone">🎤</span> HOW TO USE:
              </h3>
              <p className="pl-6 text-gray-700 dark:text-gray-300">
            ...
            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 text-gray-800 dark:text-white">
                <span role="img" aria-label="light bulb">💡</span> TRY NOW (6 languages to experience):
              </h3>
              <div className="pl-6 text-gray-700 dark:text-gray-300 italic">
