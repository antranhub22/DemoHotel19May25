          ...
          <React.Fragment key={step.title}>
            ...
            >
              ...
              <div className="text-center">
                <div className={`font-semibold font-poppins mb-0 text-[10px] ${idx + 1 === currentStep ? 'text-[#d4af37]' : 'text-[#d4af37]/70'}`}>{step.title}</div>
                <div className="font-light text-[8px] text-[#d4af37]/80 hidden md:block">{step.desc}</div>
              </div>
            </div>
            {idx < steps.length - 1 && (
      ...
      {steps.map((step, idx) => (
        ...
        >
          ...
          <div className="text-center">
            ...
            <div className={`font-light ${compact ? 'text-[10px]' : 'text-sm'} text-[#d4af37]/80`}>{step.desc}</div>
          </div>
          {idx < steps.length - 1 && (
