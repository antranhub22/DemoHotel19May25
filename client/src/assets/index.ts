...
export const referenceImages = {
  ...
  amenities: {
    ...
    roomService: '/assets/references/images/hotel-amenities/Roomfood_Service.jpg',
    ...
    decorateService: '/assets/references/images/hotel-amenities/Decorate_Service.jpg',
    freeBicycles: '/assets/references/images/hotel-amenities/Free_Bicyles Service.jpg',
  },

  // Activities & Experiences
  activities: {
    familyBeachfun1: '/assets/references/images/activities-experiences/Family_Beachfun1.jpg',
    familyBeachfun2: '/assets/references/images/activities-experiences/Family_Beachfun2.jpg',
    friendsJeepDunes1: '/assets/references/images/activities-experiences/Friends_JeepDunes1.jpg',
    friendsJeepDunes2: '/assets/references/images/activities-experiences/Friends_JeepDunes2.jpg',
    relaxingPoolside: '/assets/references/images/activities-experiences/Relaxing_Poolside.jpg',
    touristBar: '/assets/references/images/activities-experiences/Tourist_Bar.jpg',
    touristFairyStream1: '/assets/references/images/activities-experiences/Tourist_FairyStream1.jpg',
    touristFairyStream2: '/assets/references/images/activities-experiences/Tourist_FairyStream2.jpg',
    touristLocalFood: '/assets/references/images/activities-experiences/Tourist_LocalFood.jpg',
    touristSeaviewcafe: '/assets/references/images/activities-experiences/Tourist_Seaviewcafe.jpg',
    touristSunriseDune1: '/assets/references/images/activities-experiences/Tourist_SunriseDune1.jpg',
    touristSunriseDune2: '/assets/references/images/activities-experiences/Tourist_SunriseDune2.jpg',
    touristWatersport1: '/assets/references/images/activities-experiences/Tourist_Watersport1.jpg',
    touristWatersport2: '/assets/references/images/activities-experiences/Tourist_Watersport2.jpg',
  },
  ...
  landmarks: {
    ...
    muineFishingVillage1: '/assets/references/images/landmark/Muine_FishingVillage1.jpg',
    muineFishingVillage2: '/assets/references/images/landmark/Muine_FishingVillage2.jpg',
  ...
  menu: {
    ...
    vegetarian: '/assets/references/images/menu-minhon/Menu-Minhon-Vegetarian.jpg',
  },
  ...
  // Bus Tickets
  busTickets: {
    busTickets01: '/assets/references/images/bus-tickets/MiNhon-Bus Tickets01.jpg',
  },
...
export const documents = {
  beachTideChart: '/assets/references/documents/Beach & Sea (Tide Chart) 2024.pdf',
...
export const getAssetPath = (category: keyof typeof referenceImages, subcategory: string, filename: string): string => {
...
export const getImagesByCategory = (category: keyof typeof referenceImages): string[] => {
  const categoryAssets = referenceImages[category] as Record<string, string>;
