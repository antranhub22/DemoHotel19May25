...
import { z } from 'zod';
import type { UserRole, AuthErrorCode } from '../shared/types/auth';
...
export const JWT_CONFIG = {
  ...
  SECRET: process.env.JWT_SECRET || 'dev-secret-key-for-testing-only-change-in-production',
  REFRESH_SECRET: process.env.JWT_REFRESH_SECRET || process.env.JWT_SECRET || 'dev-refresh-secret-key',
...
export const DEV_CONFIG = {
  ...
  DEFAULT_DEV_USERS: [
    { username: 'admin', password: 'admin123', role: 'super-admin' as UserRole },
    { username: 'manager', password: 'manager123', role: 'hotel-manager' as UserRole },
    { username: 'frontdesk', password: 'frontdesk123', role: 'front-desk' as UserRole },
    { username: 'itmanager', password: 'itmanager123', role: 'it-manager' as UserRole },
  ],
