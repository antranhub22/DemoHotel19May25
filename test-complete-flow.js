      ...
      messages: [
        {
          role: 'user',
          content:
            'Hello, this is Tony from room 200. I would like to order 2 beef burgers and 1 orange juice for dinner. Please deliver within 30 minutes.',
        },
        {
          role: 'assistant',
          content:
            'Sure Tony! I have 2 beef burgers and 1 orange juice for room 200. Delivery within 30 minutes. Anything else?',
        },
        {
          role: 'user',
    ...
    if (requestsResponse.ok) {
      ...
      if (requests.length > 0) {
        ...
        const statusUpdateResponse = await fetch(
          `${BASE_URL}/api/staff/requests/${latestRequest.id}/status`,
          {
            method: 'PATCH',
            headers: {
              'Content-Type': 'application/json',
      ...
      console.log(
        '❌ [TEST 2] Failed to fetch requests:',
